...
import { initializeFileUpload, SUPPORTED_FILE_TYPES } from './upload.js';

console.log('Alpine.js initialization starting...');

// Register Alpine.js plugins
Alpine.plugin(persist);

// Register Alpine.js components
console.log('Registering fileUpload component...');
Alpine.data('fileUpload', initializeFileUpload);

console.log('fileUpload component registered');
